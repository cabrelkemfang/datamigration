...
public class SampleEventListener {
  ...
  @JmsListener(
      ...
      selector = DatamigrationEventConstants.SELECTOR_POST_DATAMIGRATION
  )
  public void onCreateSample(@Header(TenantHeaderFilter.TENANT_HEADER) final String tenant,
                             final String payload) {
    this.eventRecorder.event(tenant, DatamigrationEventConstants.POST_DATAMIGRATION, payload, String.class);
  }
}
