...
public class TestSample extends SuiteTestEnvironment {
  ...
  @Autowired
  private DatamigrationManager testSubject;
  ...
  public boolean waitForInitialize() {
    try {
      return this.eventRecorder.wait(DatamigrationEventConstants.INITIALIZE, APP_VERSION);
  ...
  public void shouldCreateSample() throws InterruptedException {
    ...
    Assert.assertTrue(this.eventRecorder.wait(DatamigrationEventConstants.POST_DATAMIGRATION, sample.getIdentifier()));
